...
library MetaduesGas {
    ...
    uint128 constant SUBSCRIPTION_INITIAL_BALANCE           = 2 ton;
    ...
    uint128 constant EXECUTE_SUBSCRIPTION_VALUE             = 0.5 ton;
    uint128 constant INIT_SUBSCRIPTION_VALUE                = 0.5 ton;
    ...
    uint128 constant CANCEL_MIN_VALUE                       = 0.5 ton;
}