...
tonos-cli --url $NETWORK call $configAddr setTvc "{\"tvcSubscriptionidentificatorIndexInput\":\"$subscriptionidentificatorIndexTvc\", \"tvcSubscriptionServiceInput\":\"$subscriptionServiceTvc\", \"tvcSubscriptionInput\":\"$subscriptionTvc\",\"tvcSubscriptionServiceIndexInput\":\"$subscriptionServiceIndexTvc\",\"tvcSubscriptionIndexInput\":\"$subscriptionIndexTvc\"}"  --abi ../abi/configVersions.abi.json --sign configVersions.keys.json
tonos-cli --url $NETWORK call $configAddr setAbi "{\"abiSubscriptionidentificatorIndexContractInput\":\"$abiSubscriptionidentificatorIndexContract\", \"abiServiceContractInput\":\"$abiServiceContract\",\"abiServiceIndexContractInput\":\"$abiServiceIndexContract\",\"abiSubscriptionContractInput\":\"$abiSubscriptionContract\", \"abiSubscriptionIndexContractInput\":\"$abiSubscriptionIndexContract\",\"abiSubsManDebotInput\":\"$abiSubsManDebot\"}"  --abi ../abi/configVersions.abi.json --sign configVersions.keys.json