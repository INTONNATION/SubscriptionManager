...
tonos-cli callx -m submitTransaction --addr $owner --abi ../abi/SafeMultisig.abi.json --keys owner.msig.keys.json --dest $CONTRACT_ADDRESS --value 3T --bounce true --allBalance false --payload "$message" --stateInit ""
#account=``
